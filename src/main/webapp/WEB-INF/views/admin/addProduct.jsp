		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<form:form action="${contextPath}/admin/addProductAction" method="post" modelAttribute="sanPham">
								...
								<div class="row">
									<div class="col-12">
										...
										<c:if test="${check != null}">
											<c:if test="${check}">
												<p style="color: #1fed0a; font-size: 20px">Add product success!</p>
											</c:if>
											<c:if test="${!check}">
												<p>Add product fail!</p>
											</c:if>
										</c:if>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-xl-5 col-lg-5 col-md-12 mx-auto mb-4">
										...
										<div class="custom-file mt-3 mb-3">
											...
											<input type="button" class="btn btn-primary btn-block mx-auto" value="ADD PRODUCT IMAGE"
										...
										<div class="form-group mb-3">
											...
											<input type="text" id="alternate" size="25" readonly style="color: blue">
										</div>
									...
									<div class="col-12">
										...
										<button type="submit" class="btn btn-primary btn-block text-uppercase" style="margin-bottom: 30px">Add Product</button>
									</div>
