...
<c:set var="linkImages" value="${pageContext.request.contextPath}/resources/images" />
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="${contextPath}/admin/index">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="${contextPath}/admin/product">List Product</a>
            <a class="collapse-item" href="${contextPath}/admin/addProduct">Add Product</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="${contextPath}/admin/orderedList">
